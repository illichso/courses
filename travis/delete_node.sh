...
sudo find / -name "nvm" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "nvm-*" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "nvm*" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "nvm.*" -exec rm -r "{}" \ &>/dev/null;
...
sudo find / -name "node" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "node-*" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "node_*" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "node.*" -exec rm -r "{}" \ &>/dev/null;
...
sudo find / -name "npm" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "npm-*" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "npm*" -exec rm -r "{}" \ &>/dev/null;
sudo find / -name "npm.*" -exec rm -r "{}" \ &>/dev/null;
